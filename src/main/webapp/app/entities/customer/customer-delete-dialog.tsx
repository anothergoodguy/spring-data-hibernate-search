...
export const CustomerDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="shopApp.customer.delete.question">
        <Translate contentKey="shopApp.customer.delete.question" interpolate={{ id: customerEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="tm-confirm-delete-customer" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
