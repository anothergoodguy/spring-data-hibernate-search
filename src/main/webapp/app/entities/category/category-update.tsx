  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="shopApp.category.home.createOrEditLabel" data-cy="CategoryCreateUpdateHeading">
            <Translate contentKey="shopApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('shopApp.category.description')}
              ...
              />
              <ValidatedField
                label={translate('shopApp.category.sortOrder')}
              ...
              />
              <ValidatedField
                label={translate('shopApp.category.dateAdded')}
              ...
              />
              <ValidatedField
                label={translate('shopApp.category.dateModified')}
              ...
              />
              <ValidatedField
                label={translate('shopApp.category.status')}
                id="category-status"
                name="status"
                data-cy="status"
                type="select"
              >
                {categoryStatusValues.map(categoryStatus => (
                  <option value={categoryStatus} key={categoryStatus}>
                    {translate('shopApp.CategoryStatus.' + categoryStatus)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                ...
                name="parent"
                data-cy="parent"
                label={translate('shopApp.category.parent')}
                type="select"
              >
                <option value="" key="0" />
                {categories
              ...
              <ValidatedField
                label={translate('shopApp.category.product')}
                id="category-product"
                data-cy="product"
                type="select"
                multiple
