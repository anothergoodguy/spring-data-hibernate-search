...
export const AddressDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="shopApp.address.delete.question">
        <Translate contentKey="shopApp.address.delete.question" interpolate={{ id: addressEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="tm-confirm-delete-address" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
