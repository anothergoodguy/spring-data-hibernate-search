  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="shopApp.product.home.createOrEditLabel" data-cy="ProductCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('shopApp.product.title')}
                id="product-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('shopApp.product.keywords')}
                id="product-keywords"
                name="keywords"
                data-cy="keywords"
                type="text"
              />
              <ValidatedField
                label={translate('shopApp.product.description')}
                id="product-description"
                name="description"
                data-cy="description"
                type="text"
              />
              <ValidatedField label={translate('shopApp.product.rating')} id="product-rating" name="rating" data-cy="rating" type="text" />
              <ValidatedField
                label={translate('shopApp.product.dateAdded')}
              ...
              />
              <ValidatedField
                label={translate('shopApp.product.dateModified')}
              ...
              <ValidatedField
                ...
                name="wishList"
                data-cy="wishList"
                label={translate('shopApp.product.wishList')}
                type="select"
              >
                <option value="" key="0" />
                {wishLists
