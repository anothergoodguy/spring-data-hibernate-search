...
class WishListResourceIT {
    ...
    void getAllWishListsByProductIsEqualToSomething() throws Exception {
        ...
        // Get all the wishListList where product equals to UUID.randomUUID()
        defaultWishListShouldNotBeFound("productId.equals=" + UUID.randomUUID());
    }
    ...
    void getAllWishListsByCustomerIsEqualToSomething() throws Exception {
        ...
        // Get all the wishListList where customer equals to UUID.randomUUID()
        defaultWishListShouldNotBeFound("customerId.equals=" + UUID.randomUUID());
    }
